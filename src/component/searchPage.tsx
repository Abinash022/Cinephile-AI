        ...
        <div className="flex flex-col items-center justify-center min-h-[60vh] px-6">
          ...
          <div className="relative w-full max-w-2xl mb-8">
            <div className="relative">
              ...
              <button className="absolute right-4 top-1/2 transform -translate-y-1/2 w-8 h-8 bg-red-600 rounded-full flex items-center justify-center hover:bg-red-700 transition-colors hover:scale-110">
                <svg
